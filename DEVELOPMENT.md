...
## ⚠️ CRITICAL: Leaderboard Data Files
...
🚫 **NEVER**: Run local leaderboard updates and push the results
✅ **ALWAYS**: Use GitHub Actions for all leaderboard updates
✅ **ALWAYS**: Discard local data file changes before committing
✅ **ALWAYS**: Accept GitHub's version in merge conflicts
